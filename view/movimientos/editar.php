...
<div class="row">
    ...
    <div class="row">
            ...
            <div class="input-field col s6">
                 <input id="mov_num_factura" type="number" name="mov_num_factura"class="validate" value="<?php echo $fila['mov_num_factura']?>">
                 <label for="factura">Mov Factura</label>
              </div>

              <div class="input-field col s6">
                 <input id="mov_concepto" type="text" name="mov_concepto"class="validate" value="<?php echo $fila['mov_concepto']?>">
            ...
            <div class="row">
            <div class="input-field col s6">
                 <input id="fecha" type="date" name="mov_fecha_movimiento"class="validate" value="<?php echo $fila['mov_fecha_movimiento']?>" >
                 <label for="fecha">Fecha</label>
              </div>

              <div class="input-field col s6">
                 <input id="Tipo" type="text" name="mov_tipo_movimiento"class="validate"  value="<?php echo $fila['mov_tipo_movimiento']?>" >
            ...
            <div class="row">
             ...
             <div class="input-field col s6">
                <select name="tblusuario_usu_id">
                 ...
                 <?php  
                 echo"<option value='".$fila['tblusuario_usu_id']."'>".$fila['usu_nombre1']."</option>";
                  while($row=mysqli_fetch_array($usuario)){ 
                  echo "<option value='".$fila['usu_id']."'>".$fila['usu_nombre1']." </option>"; 
            ...
            <div class="input-field col s6">
                <select name="tblproveedor_pro_nit">
                 ...
                 <?php  
                    echo"<option value='".$fila2['tblproveedor_pro_nit']."'>".$fila2['pro_nombre']."</option>";
                  while($fila2=mysqli_fetch_array($proveedor)){ 
                  echo "<option value='".$fila2['pro_id']."'>".$fila2['pro_nombre']." </option>"; 
            ...
            <button id="btn_editar22"name="btn_editar22"class="btn blue lighten-1" type="submit">Editar
            </button>
           </form>
      </div>
   </div>
