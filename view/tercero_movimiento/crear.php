...
<div class="row">
    ...
    <div class="contenedor">
            ...
            <div class="input-field col s12">
                 <input id="ter_mov_id" type="number" name="ter_mov_id"class="validate">
            ...
            <div class="row">
             ...
             <div class="input-field col s6">
                <select name="tblestado_est_codigo">
                  <option>Codigo de tercero</option>
                 <?php  
            ...
            <div class="input-field col s6">
                <select name="tbltipo_herramienta_tipo_her_id">
                  <option>codigo de movimiento</option>
                 <?php  
