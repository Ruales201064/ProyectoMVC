...
<div class="row">
    ...
    <div class="contenedor">
            ...
            <div class="input-field col s6">
                 <input id="nombre" type="text" name="her_nombre" value="<?php echo $fila['her_nombre']?>">
            ...
            <div class="input-field col s6">
                <select name="tbltipo_herramienta_tipo_her_id">
                 ...
                 <?php  
                 echo"<option value='".$fila2['tbltipo_herramienta_tipo_her_id']."'>".$fila2['tipo_her_descripcion']."</option>";
                  while($fila2=mysqli_fetch_array($herramienta)){ 
                  echo "<option value='".$fila2['tipo_her_id']."'>".$fila2['tipo_her_descripcion']." </option>"; 
            ...
            <button id="btn_editar29"name="btn_editar29"class="btn blue lighten-1" type="submit">Editar
            </button>
           </form>
      </div>
   </div>
